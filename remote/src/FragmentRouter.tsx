...
function FragmentRouteSync({ fragmentId, basePath }: { fragmentId: FragmentId; basePath: BasePath }) {
  ...
  useEffect(() => {
    ...
    const handleMessage = (event: MessageEvent) => {
      ...
      // Only react to URLs that target this fragment prefix.
  ...
  useEffect(() => {
    ...
    // Reconstruct the full host URL including the fragment base prefix.
